...
- Workspaces can have tab text colours set with set_workspace_style, and animated math-art backgrounds set with set_workspace_background. Choose background presets from waves, orbits, plasma, or stars — or invent your own with effect "formula": one math expression over x, y, r, a, t (e.g. "sin(8*r - 2*t) * exp(-r)") rendered live across the workspace, with palette/speed/density/intensity. Use effect "none" to clear a background. Formulas run in a safe whitelisted math sandbox, not arbitrary JavaScript.
